...
const sampleAbi = [
  ...
  {
    type: 'enum',
    name: 'scarb_test::EnumFnContract::NestedEnum',
    variants: [
      { name: 'NestedArray', type: 'scarb_test::EnumFnContract::Choice' },
      { name: 'Nested', type: 'scarb_test::EnumFnContract::Movement' },
      {
        name: 'ComplexNested',
        type: '(scarb_test::EnumFnContract::Choice, scarb_test::EnumFnContract::Movement)',
      },
    ],
  },
  {
    ...
    inputs: [
      {
        name: 'nested_enum',
        type: 'scarb_test::EnumFnContract::NestedEnum',
      },
    ],
    outputs: [],
    state_mutability: 'external',
  ...
  {
    type: 'struct',
    name: 'scarb_test::EnumFnContract::OrderNested',
    members: [
      { name: 'id', type: 'core::felt252' },
      { name: 'name', type: 'core::felt252' },
      { name: 'address1', type: 'core::felt252' },
      { name: 'address2', type: 'core::felt252' },
      { name: 'isDelivered', type: 'core::bool' },
    ],
  },
  {
    type: 'enum',
    name: 'scarb_test::EnumFnContract::Order',
    variants: [
      { name: 'p1', type: 'core::integer::u16' },
      { name: 'p2', type: 'core::integer::u16' },
      { name: 'details', type: 'scarb_test::EnumFnContract::OrderNested' },
    ],
  },
  {
    type: 'function',
    name: 'nested_enum_struct',
    inputs: [
      {
        name: 'nested_struct_enum',
        type: 'scarb_test::EnumFnContract::Order',
      },
    ],
    outputs: [],
    state_mutability: 'external',
  },
  {
    ...
    variants: [
      { name: 'Ok', type: 'core::integer::u16' },
      { name: 'Err', type: 'core::integer::u16' },
    ],
  },
  {
    type: 'function',
    ...
    inputs: [
      {
        name: 'inp',
        type: 'core::result::Result::<core::integer::u16, core::integer::u16>',
      },
    ],
  ...
  {
    type: 'enum',
    name: 'core::result::Result::<(core::integer::u16, core::integer::u8), core::integer::u8>',
    variants: [
      { name: 'Ok', type: '(core::integer::u16, core::integer::u8)' },
      { name: 'Err', type: 'core::integer::u8' },
    ],
  },
  {
    type: 'enum',
    name: 'core::option::Option::<core::result::Result::<(core::integer::u16, core::integer::u8), core::integer::u8>>',
    variants: [
      {
        name: 'Some',
        type: 'core::result::Result::<(core::integer::u16, core::integer::u8), core::integer::u8>',
      },
      { name: 'None', type: '()' },
    ],
  },
  {
    type: 'function',
    name: 'core_option_wrapped_result_enum',
    inputs: [
      {
        name: 'wrapper_option_result',
        type: 'core::option::Option::<core::result::Result::<(core::integer::u16, core::integer::u8), core::integer::u8>>',
      },
    ],
  ...
  },
  {
    ...
    variants: [
      { name: 'Some', type: 'core::bool' },
      { name: 'None', type: '()' },
    ],
  },
  {
    type: 'function',
    name: 'core_option_enum',
    inputs: [
      {
        name: 'should_emit_event',
